...
def simGame(weights):
    ...
    global merges
    global cornerWeight
    global monotomicWieght
    global adjWeight

    tileWeight = weights[0]
    cornerWeight = weights[1]
    monotomicWieght = weights[2]
    adjWeight = weights[3]
...
model = ga(function = simGame, dimension = 4, variable_type = 'int', variable_boundaries = varBound)
